...
1. [ ] [Compiling G2](Getting-Started-with-g2core-Development#compiling-the-code)
  - [Compiling on OSX w/Xcode](Compiling-g2core-on-OS-X-(with-Xcode))
  - [Compiling on OSX or Linux Command Line](Compiling-g2core-on-Linux-and-OS-X-(command-line))
  - [Compiling on Windows 10 w/Atmel Studio 7](Compiling-g2core-on-Windows-10-and-Atmel-Studio-7)
