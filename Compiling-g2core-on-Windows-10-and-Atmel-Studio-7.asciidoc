...
*** Change the default TAB mode from tabs to spaces (especially if you are going to contribute back to the project). Menu path is: Tools / Options / Text Editor / All Languages / Tabs. Chose the Insert Spaces option
