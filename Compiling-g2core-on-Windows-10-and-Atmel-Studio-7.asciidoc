...
- When firing up a new instance of AS7 you may get an error trying to connect to the ICE. Disconnect / reconnect the ICE - in Parallels: /Devices/External Devices, Atmel0ICE...  Disconnect and reconnect.
