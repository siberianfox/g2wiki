...
NOTE: If you are using Windows inside VMWare, please see the link:Troubleshooting#vmware-setup[VMWare Setup section of the Troubleshooting page] and [Windows 10 VMWare Fusion 8 Issues](Windows-10-VMware-Fusion-8-Issues) page.
