...
## 32/64 Bits
Go with 64 bit setup all the way if you can. Support is gradually disappearing for 32 bit packages and at some point your toolchain is likely to break if it has 32 bit components.
