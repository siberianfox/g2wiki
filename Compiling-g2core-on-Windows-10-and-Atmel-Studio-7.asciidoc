...
*** Install the 2 ARM architectures (32 bit ARM, Smart Arm) but not the 8 bit architecture (unless you are doing 8 bit development separately from g2core). This is required even though the g2core project downloads its complete toolchain.
