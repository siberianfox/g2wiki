...
* Tried updating the Segger Jlink DLL. No change in behavior observed. Segger site supports download of a windows install package that generates a JLinkARM.dll that can be installed in `Atmel Studio 6.0\avrdbg` directory. Current rDLL evsion is 4.66 up from 4.59e distributed with Studio6.0.
