...
* Go to the [official Git site](http://git-scm.com/downloads) and download and install the Git for Windows. Get the right one for your VM - 32 bit or 64 bit.
  * Option Dialog 1: Chose BASH (default, but any should work)
  * Option Dialog 2: Chose option 2, Checkout as-is, Unix style commit 
  * Option Dialog 3: Chose MinTTY (default, but  doesn't matter for our uses)
  * Option Dialog 4: Chose ON, but turn OFF if windows weirdness (works for us)
