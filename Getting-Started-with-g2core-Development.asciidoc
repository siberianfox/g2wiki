...
### link:Compiling-g2core-on-Linux-and-OS-X-(OSX command-line)[Command-Line] or https://github.com/synthetos/g2/wiki/Compiling-g2core-on-OS-X-(with-Xcode)[OSX Xcode]
### link:Compiling-g2core-on-Linux-and-OS-X-(command-line)[Linux]
### link:Compiling-g2core-on-Windows-10-and-Atmel-Studio-7[Windows 10]
