...
Be aware they seem to [result in a build error](https://github.com/synthetos/g2/issues/350#issuecomment-390467466) to due every target being compiled instead of just the selected one.  If you know how to fix that problem, please update the wiki and let us know. :smile: